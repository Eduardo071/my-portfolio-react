...
export function Contact() {
    ...
    const { theme } = useContext(ThemeContext)
        ...
        const sendEmail = (e: FormEvent) => {
          ...
          if (form.current) {
          emailjs.sendForm('service_b91l4wf', 'template_92umzu4', form.current , '_R502jfSNE_DIG3Q9')
            .then((result) => {
    ...
    return (
        ...
        <S.ContainerContact id="contact">
            ...
            <S.ContainerContactDetails backgroundcolor={theme.containerSecondaryColor}>
                ...
                <S.Form method="get" ref={form} onSubmit={sendEmail}>
                    ...
                    <S.Input textColor={theme.specialTextColor} shadowColor={theme.borderShadowColor} backgroundcolor={theme.inputsBackgroundColor} type="submit" value="Enviar" />
                </S.Form>
